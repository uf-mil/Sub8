...
# Contributors: Mike Fleming, AwesomeFleming69@ufl.edu
...
### Having build issues with simulated_sonar_ping.h?
  run:  catkin_make sub8_gazebo_generate_messages
  		catkin_make
...
### To use the sonar simulator

In Rviz add an image topic: depth/......./raw_sonar.

Tip: For best results be sure to launch oGridGen (roslaunch sub8_pointcloud ogrid.launch) and view one of the new pointcloud2 topics
